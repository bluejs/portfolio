<template>
	<div class="col-12 col-sm-6 col-md-4">
		<div class="square-flip">
			<div class='square' data-image="@/assets/img/hero/hero_right.png">
				<div class="square-container">
					<div class="align-center"><img src="@/assets/img/hero/hero_right.png" class="boxshadow" alt="portfolio title ">
					</div>

					<h2 class="textshadow" style="margin-top:20px;">作品标题</h2>
				</div>
				<div class="flip-overlay"></div>
			</div>
			<div class='square2' data-image="@/assets/img/hero/hero_right.png">
				<div class="square-container2">
					<div class="align-center"></div>
					<a href="#portfolio_1" class="boxshadow kallyas-button">查看演示</a>
				</div>
				<div class="flip-overlay"></div>
			</div>
		</div>
