                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-tittle text-center">
                            <h2>最新<span class="text-success">作品</span>展示</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
...
export default {
    ...
    mounted() {
        ...
        class Overlay {
            constructor() {
                this.DOM = { el: document.querySelector('.portfolio_overlay') };
                this.DOM.reveal = this.DOM.el.querySelector('.portfolio_overlay__reveal');
                this.DOM.items = this.DOM.el.querySelectorAll('.portfolio_overlay__item');
                this.DOM.close = this.DOM.el.querySelector('.portfolio_overlay__close');
            }
            show(contentItem) {
                this.contentItem = contentItem;
                this.DOM.el.classList.add('portfolio_overlay--open');
                // show revealer
            ...
            revealItem() {
                ...
                itemElems.push(this.contentItem.querySelector('.portfolio_overlay__content'));
            ...
            hide() {
                this.DOM.el.classList.remove('portfolio_overlay--open');
        ...
        class Grid {
            constructor(el) {
                this.DOM = { el: el };
                this.items = [];
                Array.from(this.DOM.el.querySelectorAll('a.kallyas-button')).forEach((item) => {
                    const itemObj = new Item(item);
                    this.items.push(itemObj);
                    if (!item.classList.contains('kallyas-button--noclick')) {
        ...
        let allowTilt = true;
        new Grid(document.querySelector('.square2'));
    }
};
</script>
