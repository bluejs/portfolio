                ...
                <div class="col-12 col-lg-8">
                    <div class="mb-80">
                        <div class="contact-title">
                            <h4>我们渴望倾听您的声音<br>请填写下面的表格，我们会尽快回复</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" v-validate="'required|min:3|max:34'" class="form-control mb-30"
                                            name="name" placeholder="名字" v-model="name" id="name">
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input class="form-control mb-30" v-validate="'required|email'" type="text"
                                            id="email" name="email" :placeholder="$t('contact:message.email_placeholder')"
                                            v-model="email">
                                    </div>
                                    <p class="help is-danger">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control mb-30" v-validate="'required|min:5|max:64'" type="text"
                                            :placeholder="$t('contact:message.reason_placeholder')" id="subject"
                                            v-model="subject" name="subject">
                                    </div>
                                    <p class="help is-danger">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea v-validate="'required|min:10|max:1000'" class="form-control mb-30"
                                            :placeholder="$t('contact:message.user_message_placeholder')"
                                            style="resize: none;" id="message" name="message" v-model="message"></textarea>
                                    </div>
                                    <p class="help is-danger">
                                        ...
                                        <div class="row">
                                            <div type="info">
                                                <div class="col">
                                                    ...
                                                    <div class="mt-2">
                                                        <a :href="mailToLink" class="btn btn-warning text-white">
                                ...
                                <div class="btn-group mt-5">
                                    <div class="pr-2">
                                        <a class="btn btn-default" @click="clearAll()">
                                            {{ $t('contact:message.clear_form') }}
                                        </a>
                                    </div>
                                    <div class="pl-2" style="margin: 10px 0">
                                        <button class="btn info-border btn-info e-large" type="submit"
        ...
        submitForm() {
            ...
            axios.post(CONTACT_URL, requestData)
                ...
                .catch((error) => {
                    ...
                    this.$dialog.alert({
                        title: 'Oh no...',
                        message: 'We could not deliver your message. Please try again later or contact us'
                    });
                });
        },
        validateAll() {
